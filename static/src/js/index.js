	...
	module.exports = {
		...
		init : function() {
			...
			$("#slide_lang_box a").on('click', function() {
				...
				// $("#slide_lang dt span").html('<i class=\'icon_lang
				// icon_lang_'+yy1.toLowerCase()+'\'></i>'+yy);
				...
				success : function(data) {
					if (data.obj != null) {
						...
						for (var i = 0; i < data.obj.length; i++) {
							if (data.obj[i].remark2 != undefined && data.obj[i].remark2!="") {
								...
								html += "<b class='slideUp'  style='left: 0px;  background-image: url(/" + data.obj[i].picturePath + ");'></b>";
							}
						}
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data != null && data.obj != null && data.obj[0] != null) {
						...
						$("#news_zxgg1").html(data.obj[0].title);
